package com.hillel.dzhurynskyi.homework.hm34.config;
...
@Configuration
@ComponentScan("com.hillel.dzhurynskyi.homework.hm34")
@PropertySource("classpath:hm34/database.properties")
